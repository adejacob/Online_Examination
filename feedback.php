...
<div class="col-md-10">
<a href="mailto:adeoyajacob@gmail.com" style="color:#000000">adeoyajacob@gmail.com</a><br /><br />
...
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" required="required" placeholder="Enter your name" class="form-control input-md" type="text"><br />    
   <input id="name" name="subject" required="required" placeholder="Enter subject" class="form-control input-md" type="text">    
...
<!-- Text input-->
<div class="form-group">
  <input id="email" name="email" required="required" placeholder="Enter your email-id" class="form-control input-md" type="email">    
 </div>
</div>
</div><!--End of row-->

<div class="form-group"> 
<textarea rows="5" cols="8" required="required" name="feedback" class="form-control" placeholder="Write feedback here..."></textarea>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+234 7032527373</h4>
		<h4 style="font-family:'typo' ">adeoyajacob@gmail.com</h4>
		<h4 style="font-family:'typo' ">CodeReality Academy</h4></div></div>
		</p>
      </div>
